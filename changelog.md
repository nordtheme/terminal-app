...
Implemented the main color theme file [`Nord.terminal`](https://github.com/nordtheme/terminal-app/blob/develop/src/xml/Nord.terminal). (@svengreb, #1, 0d501239)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/terminal-app/blob/develop/README.md#installation) and in the [project wiki](https://github.com/nordtheme/terminal-app/wiki).

<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/nordtheme/terminal-app/develop/src/assets/scrot-colortest.png" /><br />
  </picture>
